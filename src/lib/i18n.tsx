...
const en = {
    ...
    'settings.zoomIntro': 'Zoom in at start',
    'settings.zoomInitialLevel': 'Initial zoom level (lower is wider)',
    'settings.preZoomHold': 'Hold before zoom (s)',
    'settings.zoomDuration': 'Zoom duration (s)',
    'settings.startHold': 'Hold after zoom (s)',
    ...
    'settings.pinScale': 'Pin size ({value}×)',
...
const ja: Partial<Record<MessageKey, string>> = {
    ...
    'settings.zoomIntro': '開始時にズーム',
    'settings.zoomInitialLevel': '初期ズームレベル（小さいほど広域）',
    'settings.preZoomHold': 'ズーム前の待機時間（秒）',
    'settings.zoomDuration': 'ズーム時間（秒）',
    'settings.startHold': 'ズーム後の待機時間（秒）',
    ...
    'settings.pinScale': 'ピンの大きさ（{value}倍）',
